...
public class AoEShrineBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        if (nbt.getBoolean("players") || nbt.getBoolean("monsters")){
            components.add(nbt.getBoolean("players")
                    ? Component.translatable("tooltip.potion_shrines.players")
                    .append(nbt.getBoolean("monsters")
                            ? Component.literal(" & ").append(Component.translatable("tooltip.potion_shrines.monsters"))
                            : Component.literal("")).withStyle(ChatFormatting.BLUE)
                    : Component.translatable("tooltip.potion_shrines.monsters").withStyle(ChatFormatting.BLUE));
        }
    }
    @Override
